...
# Import re to remove punctuation for final output.
import re 

# Import getString from pcinput.py to remove leading/trailing spaces.
...
for w in words:
    if index % 2 == 0: # returns indexes 0, 2, 4, 6, etc.
        list_second.append(w) # adds every second word to the new list
...
# There should be no punctuation except for apostrophes that are part of some words (they're, we're, etc.)
